...
local bundles = {
  vim.fn.glob(
    home .. "/java-debug/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar"
  ),
}
    ...
    java = {
      ...
      configuration = {
        runtimes = {
          {
            name = "JavaSE-21",
            path = home .. "/.jenv/versions/21.0/libexec/openjdk.jdk/Contents/Home",
          },
        },
      },
    },
